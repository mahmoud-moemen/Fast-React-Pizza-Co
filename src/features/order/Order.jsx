...
function Order() {
  ...
  //fetch data that is associated to another route
    ...
    <div className="space-y-6 px-4 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="space-x-2">
          {priority && (
            <span
              className="rounded-full bg-red-500 px-1 py-1 text-sm
          ...
          <span
            className="rounded-full bg-green-500 px-1 py-1 text-sm
